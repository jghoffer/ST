 ...
 */
metadata {
	definition (name: "Gen5+", namespace: "smartthings", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
...
def zwaveEvent(physicalgraph.zwave.commands.sensormultilevelv5.SensorMultilevelReport cmd)
{
	...
	switch (cmd.sensorType) {
		case 1:
            ...
            def cmdValue = cmd.scaledSensorValue
            cmdValue = cmdValue + 5
			map.value = convertTemperatureIfNeeded(cmdValue, cmdScale, cmd.precision)                    
           // sendEvent(name:"value", value:"$cmdValue or ${map.value as Float}")
